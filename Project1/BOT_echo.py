...
if __name__ == "__main__":
    ...
    PILOT_CORES = 1
    BAG_SIZE = 2 # The number of units
    ...
    try:
	    ...
	    cudesc.executable = "/bin/echo"
            #cudesc.arguments = ['bubble_sort_rp_%s.py' % i]
            cudesc.arguments = 'Hello World!'
            #cudesc.input_staging = ['bubble_sort_rp_%s.py' % i]
	    #cudesc.output_staging = ['bubble_sort_rp_%s.py' % i]
            cudesc.environment = {'CU_NO': i}
            cudesc.cpu_processes       = 1
