...
""" DESCRIPTION: SORTING 5 FILES WITH NUMBERS
"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range(BAG_SIZE):
            ...
            cudesc.arguments = ['-l','c','base64 /dev/urandom | head -c 100000 > output.txt']
            #cudesc.input_staging = ['Input/Input%s.txt' % (i+1)]
	    #cudesc.output_staging = ['Output/Output%s.txt' % (i+1)]
            #cudesc.input_staging = 'Input/Input1.txt'
	    #cudesc.output_staging = 'Output/Output1.txt'
